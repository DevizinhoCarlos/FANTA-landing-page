//criaçao de uma timeline do gsap com animçoes soncronizadas com o scroll//
...
tl.to(
  '#laranja-cortada',{
      top: '160%', //MOVE O ELEMENTO COM ID 'ORAGEN-CUT' PARA 160% DO TOPO
      left: '23%', //MOVE O ELEMENTO PARA  23% DA ESQUERDA
  },
  'orange'
); //SINCRONIZADO COM A ANIMAÇAO NOEMADA 'ORAGEN'
...
tl.to(
  '#laranja',
  {
      ...
      right: '10%', // MOVE O ELEMNTO PARA 10% DA DIREITA 
  },
);// SINCRONIZANDO COM A ANIMAÇAO NOEMADA 'ORANGE'
